CREATE TABLE address (
    ...
    CONSTRAINT fk_entity_types_id FOREIGN KEY (entity_types_id) REFERENCES entity_types(id),
...
INSERT INTO address(entity_types_id, address_type, address_line_1, 
...
(SELECT id FROM cities WHERE city = 'Jehanabad'),
(SELECT id FROM states WHERE state = 'Bihar'), 'INDIA', 
'804428', '8789906286', 'Ajeet Shaw', 'imajeetshaw.99@gmial.com');